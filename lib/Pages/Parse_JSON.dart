...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return const MaterialApp(
      title: appTitle,
      home: MyParseJSONApp(title: appTitle),
    );
  }
}

class MyParseJSONApp extends StatelessWidget {
  const MyParseJSONApp({super.key, required this.title});
...
class PhotosList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      //itemBuilder: (context, index) {return Text('${index+1}:${photos[index].thumbnailUrl}');},
    );
  }
}