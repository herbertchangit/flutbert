...
class _ExampleCupertinoDownloadButtonState
  ...
  Widget build(BuildContext context) {
    debugPrint('Total list item : ${_downloadControllers.length}');
    return Scaffold(
      appBar: AppBar(title: const Text('Download listing')),
...
class DownloadButton extends StatelessWidget {
  ...
  void _onPressed() {
    ...
    debugPrint('_isFetching : $_isFetching');
    debugPrint('_isDownloaded : $_isDownloaded');
